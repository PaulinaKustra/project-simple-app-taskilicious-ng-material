...
@NgModule({
  ...
  ]), CategoriesComponentModule, CategoryServiceModule, CategoryFormCreateComponentModule, CategoryFormEditComponentModule, CategoryDetailComponentModule, TaskServiceModule, TaskFormCreateComponentModule, TaskFormEditComponentModule],
