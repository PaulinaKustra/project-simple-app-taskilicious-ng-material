...
} from './components/category-form-create/category-form-create.component-module';
...
@NgModule({
    ...
    ]), CategoriesComponentModule, CategoryServiceModule, CategoryFormCreateComponentModule,
        CategoryFormEditComponentModule, CategoryDetailComponentModule, TaskServiceModule,
        TaskFormCreateComponentModule, TaskFormEditComponentModule, TeamMemberServiceModule],
