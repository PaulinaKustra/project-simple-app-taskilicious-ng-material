...
import { TaskListComponentModule } from './components/task-list/task-list.component-module';
...
@NgModule({
  ...
  ]), CategoriesComponentModule, CategoryServiceModule, CategoryFormCreateComponentModule, CategoryFormEditComponentModule, CategoryDetailComponentModule, TaskServiceModule, TaskFormCreateComponentModule, TaskFormEditComponentModule, TeamMemberServiceModule, UploadcareServiceModule, TaskListComponentModule],
